...
import com.njusoft.its.service.IRedisService;
import com.njusoft.its.utils.JSONUtil;
...
public class RedisServiceImpl implements IRedisService{
		...
		@Override
		public boolean delete(String key,Class clz) {
			redisTemplate.delete(key);
			return true;
		}

		@Override
		public boolean setBean(String key, Object clz) {
			String value = JSONUtil.toJson(clz);
			return set(key,value);
		}

		@Override
		public  Object getBean(String key, Class clz) {
			String json = get(key);
			if(json!=null){
				Object  bean = JSONUtil.toBean(json, clz);
				return bean;
			}
			return null;
		}
